...
motorbike1 = Motorbike.create(name: "YZF-R1", brand: "Yamaha", color: "Black", year: "2023", price: "50", address: "92 Bd de Clichy, 75018 Paris")
motorbike2 = Motorbike.create(name: "Scoopy", brand: "Scoopy", color: "Red", year: "2018", price: "20", address: "1 Bd Montmartre, 75002 Paris")
motorbike3 = Motorbike.create(name: "PCX", brand: "PCX", color: "Blue", year: "1993", price: "30", address: "7 Bd Montmartre, 75002 Paris")
motorbike4 = Motorbike.create(name: "Ninja", brand: "Kawasaki", color: "White", year: "1994", price: "60", address: "34 Quai d'Austerlitz, 75013 Paris")
